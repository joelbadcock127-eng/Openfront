...
| 5   | **Rivers**             | Rivers are navigable **estuaries**: the lower reaches near the sea (Murray mouth, Yarra into Melbourne, Fly, Waikato…) are wide ocean-connected channels ships can sail up. Upstream they never obstruct land expansion — no thin water lines across the interior. | pipeline (`paintRivers`)                    |
