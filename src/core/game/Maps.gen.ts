...
export enum GameMapType {
  ...
  // Generated by scripts/world/build-world.ts (world pipeline), not the Go
  // map generator: playable windows of the continuous world map.
  WorldWindow = "World Window", // resources/maps/worldwindow/manifest.json
  NewZealandSouth = "New Zealand South", // resources/maps/newzealandsouth/manifest.json
  NewZealandNorth = "New Zealand North", // resources/maps/newzealandnorth/manifest.json
  TorresStrait = "Torres Strait", // resources/maps/torresstrait/manifest.json
  EastAustralia = "East Australia", // resources/maps/eastaustralia/manifest.json
...
export const maps: readonly MapInfo[] = [
  ...
  {
    id: "WorldWindow",
    type: GameMapType.WorldWindow,
    translationKey: "map.worldwindow",
    categories: ["continental", "oceania"],
    multiplayerFrequency: 0,
  },
  {
    id: "NewZealandSouth",
    type: GameMapType.NewZealandSouth,
    translationKey: "map.newzealandsouth",
    categories: ["continental", "oceania"],
    multiplayerFrequency: 0,
  },
  {
    id: "NewZealandNorth",
    type: GameMapType.NewZealandNorth,
    translationKey: "map.newzealandnorth",
    categories: ["continental", "oceania"],
    multiplayerFrequency: 0,
  },
  {
    id: "TorresStrait",
    type: GameMapType.TorresStrait,
    translationKey: "map.torresstrait",
    categories: ["continental", "oceania"],
    multiplayerFrequency: 0,
  },
  {
    id: "EastAustralia",
    type: GameMapType.EastAustralia,
    translationKey: "map.eastaustralia",
    categories: ["continental", "oceania"],
    multiplayerFrequency: 0,
  },
  {
